...
module.exports = ProteanSubject.extend(FiniteStateMachine,
    ...
    /**
     * @param {ProteanFiniteState|String} state
     ...
     * @param {String} action
     */
    trigger: function (action) { this.onNext(action); },
    /**
     * @private
     * @param {String} action
     */
 ...
 * @type Object
 * @property {String} type The action that sparked this transition
