...
describe('Storage', function () {
    [ ['Memory', require('protean/storage/memory')],
        ['Local', require('protean/storage/local')],
        ['Session', require('protean/storage/session')]
    ].
    forEach(function (args) {
        var name = args[0] + 'Storage';
        var storage = new args[1]();
